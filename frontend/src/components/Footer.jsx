      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="flex items-center flex-shrink-0 text-white mr-6">
          ...
          <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Contact Us</h2>
                <p className="mb-4">1234 Elm Street</p>
                <p className="mb-4">City Name, Country</p>
                <p className="mb-4">Email: info@travelplanner.com</p>
                <p className="mb-4">Phone: +1 (123) 456-7890</p>
              </div>
              <div className="ml-10 text-gray-500 dark:text-gray-400 font-medium">
            ...
            <div>
              <h2 className="mb-6 mr-10 text-sm font-semibold text-gray-900 uppercase dark:text-white">
                Legal
              </h2>
